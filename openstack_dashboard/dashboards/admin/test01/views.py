...
from openstack_dashboard import usage2
...
class GlobalOverview(usage2.UsageView):
    table_class = usage2.GlobalUsageTable
    usage_class = usage2.GlobalUsage
    template_name = 'admin/test01/usage.html'
