...
def parse_configs_from_context(context, defaults):
    ...
    for key, val in context.items():
        if str(key).startswith("CONF"):
            ...
            # http://jira.daumkakao.com/browse/CCC-917
            # we will using the default value as kakao default configuration.
            # in sahara, default value means the CDH default value.
            #if (val is None or
